  ...
  return (
    <div className="min-h-screen bg-[#F5F3EE] text-[#111111] font-sans selection:bg-[#FACC15] selection:text-black">
        ...
        <nav className="bg-[#F5F3EE] border-b-4 border-black transition-all duration-300">
          <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-5 font-bold text-xs uppercase tracking-widest">
              ...
              <a href="mailto:helstandsouza@gmail.com" className="bg-[#FACC15] text-black border-[3px] border-black px-5 py-2 rounded shadow-[4px_4px_0px_#000] hover:-translate-y-0.5 hover:-translate-x-0.5 hover:shadow-[6px_6px_0px_#000] active:translate-x-1 active:translate-y-1 active:shadow-none transition-all whitespace-nowrap">
                Book a Call
              </a>
            </div>
            <div className="md:hidden flex items-center gap-2">
              <a href="mailto:helstandsouza@gmail.com" className="bg-[#FACC15] text-black border-[3px] border-black px-3 py-1.5 rounded shadow-[3px_3px_0px_#000] font-bold uppercase text-xs transition-all hover:shadow-[5px_5px_0px_#000]">
                Talk
              </a>
            </div>
          </div>
      ...
      <main className="relative z-10">
        ...
        {/* WHY ME (Parallax) */}
        <section id="whyme" className="relative">
          ...
          {/* CONTACT */}
          <section id="contact" className="sticky top-[108px] min-h-screen bg-[#FACC15] border-4 border-black flex flex-col items-center justify-center p-6 md:p-24 text-center overflow-hidden z-40">
